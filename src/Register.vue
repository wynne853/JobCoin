      ...
      <div class="flex flex-col items-center justify-between xl:flex-row">
        <div class="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
          <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
            ...
            e rápida para gerenciar <span class="text-indigo-600">suas vagas</span>
          </h2>
          <p class="max-w-xl mb-4 text-base text-gray-400 md:text-lg">
            <span class="font-extrabold text-white">Cadastre-se</span> para entrar em um mundo de vagas.
          </p>
        </div>
            ...
            <div class="relative bg-white rounded shadow-2xl p-7 sm:p-10">
              ...
              <form @submit.stop.prevent="register">
                <div class="mb-1 sm:mb-2">
                  <label for="name" class="inline-block mb-1 font-medium">Seu nome</label>
                  <input
                    v-model="name"
                ...
                <div class="mt-4 mb-2 sm:mb-4">
                  <button type="submit" :disabled="btnLogin" class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-600 hover:bg-indigo-800 focus:shadow-outline focus:outline-none">
                     <loading :loading="btnLoading">Cadastrar</loading>
                  </button>
                </div>
                <p class="text-xs text-gray-600 sm:text-sm">
                 Já possui uma conta? <router-link to="/entrar"><span class="text-indigo-600 font-extrabold underline pointer-click">Entre</span></router-link>
                </p>
              </form>
            </div>
          </div>
          ...
          try {
              ...
              if (error.response) {
                 ...
                 this.$swal.fire({
                  icon: 'error',
                  title: 'Oops...',
                  text: 'Senha deve conter mais de 8 caracteres!',
                })
